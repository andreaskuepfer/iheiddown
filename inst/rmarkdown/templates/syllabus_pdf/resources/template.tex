...
\subsectionfont{\color{5D85C3}\fontsize{10}{12}\selectfont}
...
\renewcommand{\thesubsection}{\textcolor{5D85C3} Woche \arabic{subsection}}%... from subsections
...
\textbf{\textcolor{5D85C3}{$program$}}

Akademisches Jahr $year$
\vspace{0.25cm}

\textbf{\textcolor{5D85C3}{$title$}}

$code$ -- $semester$ -- $credits$ ECTS
\vspace{0.25cm}

\textbf{\textcolor{5D85C3}{Seminarbeschreibung}}
...
\textbf{\textcolor{5D85C3}{Syllabus}}	
